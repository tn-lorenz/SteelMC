...
/// Vanilla `NetherSproutsBlock` survival.
...
impl NetherSproutsBlock {
    /// Creates a new nether sprouts block behavior.
    #[must_use]
...
impl BlockBehavior for NetherSproutsBlock {
    fn can_survive(&self, _state: BlockStateId, world: &dyn LevelReader, pos: BlockPos) -> bool {
        survives_on_tag(world, pos, &vanilla_block_tags::SUPPORTS_NETHER_SPROUTS_TAG)
    }
