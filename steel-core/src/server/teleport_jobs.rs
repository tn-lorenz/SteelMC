use super::{
    ...
    ChunkStorage, ChunkTicketKind, DVec3, EntityBase, JobPoll, NetworkConnection,
    PendingWorldChangeToken, PersistentEntity, PersistentRootVehicle, Player, PlayerSpawnSearch,
    PlayerSpawnSearchPoll, RemovalReason, RespawnData, ServerJob, ServerJobContext, SharedEntity,
    Uuid, World, change_entity_world, end_gateway, end_portal, is_allowed_to_enter_portal,
    nether_portal, vanilla_entities,
};

pub(super) struct RootVehicleRestoreJob {
    player: Arc<Player>,
    world: Arc<World>,
...
pub(super) fn clear_pending_world_change(
    entity: &SharedEntity,
...
pub(super) fn portal_entity_still_valid(
    entity: &SharedEntity,
...
pub(super) struct NetherPortalTeleportJob {
    entity: SharedEntity,
    source_world: Arc<World>,
...
pub(super) struct EndPortalTeleportJob {
    entity: SharedEntity,
    source_world: Arc<World>,
    pending_token: PendingWorldChangeToken,
...
pub(super) struct EndGatewayTeleportJob {
    entity: SharedEntity,
    source_world: Arc<World>,
    portal_pos: BlockPos,
    source_is_end: bool,
...
pub(super) struct EnderPearlRestoreJob {
    player: Arc<Player>,
    world: Arc<World>,
    request: ChunkRequestHandle,
    uuid: Uuid,
