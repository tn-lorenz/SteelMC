...
pub const PODZOL: Block = Block::new(
    "podzol",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::SNOWY],
);
...
pub const PALE_OAK_WOOD: Block = Block::new(
    "pale_oak_wood",
    BlockBehaviourProperties::new(),
...
pub const MANGROVE_PROPAGULE: Block = Block::new(
    "mangrove_propagule",
    BlockBehaviourProperties::new(),
    &[
...
pub const OAK_LOG: Block = Block::new(
    "oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const SPRUCE_LOG: Block = Block::new(
    "spruce_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const BIRCH_LOG: Block = Block::new(
    "birch_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const JUNGLE_LOG: Block = Block::new(
    "jungle_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const ACACIA_LOG: Block = Block::new(
    "acacia_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const CHERRY_LOG: Block = Block::new(
    "cherry_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const DARK_OAK_LOG: Block = Block::new(
    "dark_oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const PALE_OAK_LOG: Block = Block::new(
    "pale_oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const MANGROVE_LOG: Block = Block::new(
    "mangrove_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const MANGROVE_ROOTS: Block = Block::new(
    "mangrove_roots",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const MUDDY_MANGROVE_ROOTS: Block = Block::new(
    "muddy_mangrove_roots",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const BAMBOO_BLOCK: Block = Block::new(
    "bamboo_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_SPRUCE_LOG: Block = Block::new(
    "stripped_spruce_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_BIRCH_LOG: Block = Block::new(
    "stripped_birch_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_JUNGLE_LOG: Block = Block::new(
    "stripped_jungle_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_ACACIA_LOG: Block = Block::new(
    "stripped_acacia_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_CHERRY_LOG: Block = Block::new(
    "stripped_cherry_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_DARK_OAK_LOG: Block = Block::new(
    "stripped_dark_oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_PALE_OAK_LOG: Block = Block::new(
    "stripped_pale_oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_OAK_LOG: Block = Block::new(
    "stripped_oak_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_MANGROVE_LOG: Block = Block::new(
    "stripped_mangrove_log",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_BAMBOO_BLOCK: Block = Block::new(
    "stripped_bamboo_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const OAK_WOOD: Block = Block::new(
    "oak_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const SPRUCE_WOOD: Block = Block::new(
    "spruce_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const BIRCH_WOOD: Block = Block::new(
    "birch_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const JUNGLE_WOOD: Block = Block::new(
    "jungle_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const ACACIA_WOOD: Block = Block::new(
    "acacia_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const CHERRY_WOOD: Block = Block::new(
    "cherry_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const DARK_OAK_WOOD: Block = Block::new(
    "dark_oak_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const MANGROVE_WOOD: Block = Block::new(
    "mangrove_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_OAK_WOOD: Block = Block::new(
    "stripped_oak_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_SPRUCE_WOOD: Block = Block::new(
    "stripped_spruce_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_BIRCH_WOOD: Block = Block::new(
    "stripped_birch_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_JUNGLE_WOOD: Block = Block::new(
    "stripped_jungle_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_ACACIA_WOOD: Block = Block::new(
    "stripped_acacia_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_CHERRY_WOOD: Block = Block::new(
    "stripped_cherry_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_DARK_OAK_WOOD: Block = Block::new(
    "stripped_dark_oak_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_PALE_OAK_WOOD: Block = Block::new(
    "stripped_pale_oak_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_MANGROVE_WOOD: Block = Block::new(
    "stripped_mangrove_wood",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const OAK_LEAVES: Block = Block::new(
    "oak_leaves",
    BlockBehaviourProperties::new(),
    &[
...
pub const SPRUCE_LEAVES: Block = Block::new(
    "spruce_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const BIRCH_LEAVES: Block = Block::new(
    "birch_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const JUNGLE_LEAVES: Block = Block::new(
    "jungle_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const ACACIA_LEAVES: Block = Block::new(
    "acacia_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const CHERRY_LEAVES: Block = Block::new(
    "cherry_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const DARK_OAK_LEAVES: Block = Block::new(
    "dark_oak_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const PALE_OAK_LEAVES: Block = Block::new(
    "pale_oak_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const MANGROVE_LEAVES: Block = Block::new(
    "mangrove_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const AZALEA_LEAVES: Block = Block::new(
    "azalea_leaves",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DISTANCE,
...
pub const FLOWERING_AZALEA_LEAVES: Block = Block::new(
...
pub const DISPENSER: Block = Block::new(
    "dispenser",
    BlockBehaviourProperties::new(),
    &[
...
pub const NOTE_BLOCK: Block = Block::new(
    "note_block",
    BlockBehaviourProperties::new(),
    &[
...
pub const WHITE_BED: Block = Block::new(
    "white_bed",
    BlockBehaviourProperties::new(),
    &[
...
pub const ORANGE_BED: Block = Block::new(
    "orange_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MAGENTA_BED: Block = Block::new(
    "magenta_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const LIGHT_BLUE_BED: Block = Block::new(
    "light_blue_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const YELLOW_BED: Block = Block::new(
    "yellow_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const LIME_BED: Block = Block::new(
    "lime_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PINK_BED: Block = Block::new(
    "pink_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const GRAY_BED: Block = Block::new(
    "gray_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const LIGHT_GRAY_BED: Block = Block::new(
    "light_gray_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CYAN_BED: Block = Block::new(
    "cyan_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PURPLE_BED: Block = Block::new(
    "purple_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BLUE_BED: Block = Block::new(
    "blue_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BROWN_BED: Block = Block::new(
    "brown_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const GREEN_BED: Block = Block::new(
    "green_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const RED_BED: Block = Block::new(
    "red_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BLACK_BED: Block = Block::new(
    "black_bed",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const POWERED_RAIL: Block = Block::new(
    "powered_rail",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const DETECTOR_RAIL: Block = Block::new(
    "detector_rail",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const STICKY_PISTON: Block = Block::new(
    "sticky_piston",
    BlockBehaviourProperties::new(),
    &[
...
pub const TALL_SEAGRASS: Block = Block::new(
    "tall_seagrass",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const PISTON: Block = Block::new(
    "piston",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EXTENDED,
...
pub const PISTON_HEAD: Block = Block::new(
    "piston_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const MOVING_PISTON: Block = Block::new(
    "moving_piston",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const ACACIA_SHELF: Block = Block::new(
    "acacia_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_SHELF: Block = Block::new(
    "bamboo_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_SHELF: Block = Block::new(
    "birch_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_SHELF: Block = Block::new(
    "cherry_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CRIMSON_SHELF: Block = Block::new(
    "crimson_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_SHELF: Block = Block::new(
    "dark_oak_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_SHELF: Block = Block::new(
    "jungle_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_SHELF: Block = Block::new(
    "mangrove_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OAK_SHELF: Block = Block::new(
    "oak_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_SHELF: Block = Block::new(
    "pale_oak_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SPRUCE_SHELF: Block = Block::new(
    "spruce_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_SHELF: Block = Block::new(
    "warped_shelf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WALL_TORCH: Block = Block::new(
    "wall_torch",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const FIRE: Block = Block::new(
    "fire",
    BlockBehaviourProperties::new(),
    &[
...
pub const CREAKING_HEART: Block = Block::new(
    "creaking_heart",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AXIS,
...
pub const OAK_STAIRS: Block = Block::new(
    "oak_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHEST: Block = Block::new(
    "chest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const FURNACE: Block = Block::new(
    "furnace",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OAK_SIGN: Block = Block::new(
    "oak_sign",
    BlockBehaviourProperties::new(),
    &[
...
pub const SPRUCE_SIGN: Block = Block::new(
    "spruce_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const BIRCH_SIGN: Block = Block::new(
    "birch_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const ACACIA_SIGN: Block = Block::new(
    "acacia_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const CHERRY_SIGN: Block = Block::new(
    "cherry_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const JUNGLE_SIGN: Block = Block::new(
    "jungle_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const DARK_OAK_SIGN: Block = Block::new(
    "dark_oak_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const PALE_OAK_SIGN: Block = Block::new(
    "pale_oak_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const MANGROVE_SIGN: Block = Block::new(
    "mangrove_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const BAMBOO_SIGN: Block = Block::new(
    "bamboo_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const OAK_DOOR: Block = Block::new(
    "oak_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const RAIL: Block = Block::new(
    "rail",
    BlockBehaviourProperties::new(),
    &[
...
pub const COBBLESTONE_STAIRS: Block = Block::new(
    "cobblestone_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OAK_WALL_SIGN: Block = Block::new(
    "oak_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SPRUCE_WALL_SIGN: Block = Block::new(
    "spruce_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_WALL_SIGN: Block = Block::new(
    "birch_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ACACIA_WALL_SIGN: Block = Block::new(
    "acacia_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_WALL_SIGN: Block = Block::new(
    "cherry_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_WALL_SIGN: Block = Block::new(
    "jungle_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_WALL_SIGN: Block = Block::new(
    "dark_oak_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_WALL_SIGN: Block = Block::new(
    "pale_oak_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_WALL_SIGN: Block = Block::new(
    "mangrove_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_WALL_SIGN: Block = Block::new(
    "bamboo_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OAK_HANGING_SIGN: Block = Block::new(
    "oak_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
...
pub const SPRUCE_HANGING_SIGN: Block = Block::new(
    "spruce_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const BIRCH_HANGING_SIGN: Block = Block::new(
    "birch_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const ACACIA_HANGING_SIGN: Block = Block::new(
    "acacia_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const CHERRY_HANGING_SIGN: Block = Block::new(
    "cherry_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const JUNGLE_HANGING_SIGN: Block = Block::new(
    "jungle_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const DARK_OAK_HANGING_SIGN: Block = Block::new(
...
pub const PALE_OAK_HANGING_SIGN: Block = Block::new(
...
pub const CRIMSON_HANGING_SIGN: Block = Block::new(
...
pub const WARPED_HANGING_SIGN: Block = Block::new(
    "warped_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const MANGROVE_HANGING_SIGN: Block = Block::new(
...
pub const BAMBOO_HANGING_SIGN: Block = Block::new(
    "bamboo_hanging_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const OAK_WALL_HANGING_SIGN: Block = Block::new(
...
pub const SPRUCE_WALL_HANGING_SIGN: Block = Block::new(
...
pub const BIRCH_WALL_HANGING_SIGN: Block = Block::new(
...
pub const ACACIA_WALL_HANGING_SIGN: Block = Block::new(
...
pub const CHERRY_WALL_HANGING_SIGN: Block = Block::new(
...
pub const JUNGLE_WALL_HANGING_SIGN: Block = Block::new(
...
pub const DARK_OAK_WALL_HANGING_SIGN: Block = Block::new(
...
pub const PALE_OAK_WALL_HANGING_SIGN: Block = Block::new(
...
pub const MANGROVE_WALL_HANGING_SIGN: Block = Block::new(
...
pub const CRIMSON_WALL_HANGING_SIGN: Block = Block::new(
...
pub const WARPED_WALL_HANGING_SIGN: Block = Block::new(
...
pub const BAMBOO_WALL_HANGING_SIGN: Block = Block::new(
...
pub const LEVER: Block = Block::new(
    "lever",
    BlockBehaviourProperties::new(),
    &[
...
pub const STONE_PRESSURE_PLATE: Block = Block::new(
    "stone_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const IRON_DOOR: Block = Block::new(
    "iron_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OAK_PRESSURE_PLATE: Block = Block::new(
    "oak_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const SPRUCE_PRESSURE_PLATE: Block = Block::new(
    "spruce_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const BIRCH_PRESSURE_PLATE: Block = Block::new(
    "birch_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const JUNGLE_PRESSURE_PLATE: Block = Block::new(
    "jungle_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const ACACIA_PRESSURE_PLATE: Block = Block::new(
    "acacia_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const CHERRY_PRESSURE_PLATE: Block = Block::new(
    "cherry_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const DARK_OAK_PRESSURE_PLATE: Block = Block::new(
    "dark_oak_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const PALE_OAK_PRESSURE_PLATE: Block = Block::new(
    "pale_oak_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const MANGROVE_PRESSURE_PLATE: Block = Block::new(
    "mangrove_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const BAMBOO_PRESSURE_PLATE: Block = Block::new(
    "bamboo_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const REDSTONE_ORE: Block = Block::new(
    "redstone_ore",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const DEEPSLATE_REDSTONE_ORE: Block = Block::new(
    "deepslate_redstone_ore",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const REDSTONE_TORCH: Block = Block::new(
    "redstone_torch",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const REDSTONE_WALL_TORCH: Block = Block::new(
    "redstone_wall_torch",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const STONE_BUTTON: Block = Block::new(
    "stone_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const JUKEBOX: Block = Block::new(
    "jukebox",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HAS_RECORD],
);
pub const OAK_FENCE: Block = Block::new(
    "oak_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const BASALT: Block = Block::new(
    "basalt",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const POLISHED_BASALT: Block = Block::new(
    "polished_basalt",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const SOUL_TORCH: Block = Block::new("soul_torch", BlockBehaviourProperties::new(), &[]);
pub const SOUL_WALL_TORCH: Block = Block::new(
    "soul_wall_torch",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const COPPER_TORCH: Block = Block::new("copper_torch", BlockBehaviourProperties::new(), &[]);
pub const COPPER_WALL_TORCH: Block = Block::new(
    "copper_wall_torch",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const GLOWSTONE: Block = Block::new("glowstone", BlockBehaviourProperties::new(), &[]);
pub const NETHER_PORTAL: Block = Block::new(
    "nether_portal",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_AXIS],
);
pub const CARVED_PUMPKIN: Block = Block::new(
    "carved_pumpkin",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const JACK_O_LANTERN: Block = Block::new(
    "jack_o_lantern",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
...
pub const REPEATER: Block = Block::new(
    "repeater",
    BlockBehaviourProperties::new(),
    &[
...
pub const OAK_TRAPDOOR: Block = Block::new(
    "oak_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SPRUCE_TRAPDOOR: Block = Block::new(
    "spruce_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_TRAPDOOR: Block = Block::new(
    "birch_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_TRAPDOOR: Block = Block::new(
    "jungle_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ACACIA_TRAPDOOR: Block = Block::new(
    "acacia_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_TRAPDOOR: Block = Block::new(
    "cherry_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_TRAPDOOR: Block = Block::new(
    "dark_oak_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_TRAPDOOR: Block = Block::new(
    "pale_oak_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_TRAPDOOR: Block = Block::new(
    "mangrove_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_TRAPDOOR: Block = Block::new(
    "bamboo_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BROWN_MUSHROOM_BLOCK: Block = Block::new(
...
pub const RED_MUSHROOM_BLOCK: Block = Block::new(
    "red_mushroom_block",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const MUSHROOM_STEM: Block = Block::new(
    "mushroom_stem",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const IRON_BARS: Block = Block::new(
    "iron_bars",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const COPPER_BARS: Block = Block::new(
    "copper_bars",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const EXPOSED_COPPER_BARS: Block = Block::new(
    "exposed_copper_bars",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const WEATHERED_COPPER_BARS: Block = Block::new(
...
pub const OXIDIZED_COPPER_BARS: Block = Block::new(
...
pub const WAXED_COPPER_BARS: Block = Block::new(
    "waxed_copper_bars",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const WAXED_EXPOSED_COPPER_BARS: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_BARS: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_BARS: Block = Block::new(
...
pub const IRON_CHAIN: Block = Block::new(
    "iron_chain",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AXIS,
...
pub const COPPER_CHAIN: Block = Block::new(
    "copper_chain",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AXIS,
...
pub const EXPOSED_COPPER_CHAIN: Block = Block::new(
...
pub const WEATHERED_COPPER_CHAIN: Block = Block::new(
...
pub const OXIDIZED_COPPER_CHAIN: Block = Block::new(
...
pub const WAXED_COPPER_CHAIN: Block = Block::new(
    "waxed_copper_chain",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AXIS,
...
pub const WAXED_EXPOSED_COPPER_CHAIN: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_CHAIN: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_CHAIN: Block = Block::new(
...
pub const GLASS_PANE: Block = Block::new(
    "glass_pane",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const ATTACHED_PUMPKIN_STEM: Block = Block::new(
    "attached_pumpkin_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const ATTACHED_MELON_STEM: Block = Block::new(
    "attached_melon_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
...
pub const VINE: Block = Block::new(
    "vine",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const GLOW_LICHEN: Block = Block::new(
    "glow_lichen",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const RESIN_CLUMP: Block = Block::new(
    "resin_clump",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const OAK_FENCE_GATE: Block = Block::new(
    "oak_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BRICK_STAIRS: Block = Block::new(
    "brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const STONE_BRICK_STAIRS: Block = Block::new(
    "stone_brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MUD_BRICK_STAIRS: Block = Block::new(
    "mud_brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MYCELIUM: Block = Block::new(
    "mycelium",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::SNOWY],
);
...
pub const RESIN_BRICK_STAIRS: Block = Block::new(
    "resin_brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const RESIN_BRICK_SLAB: Block = Block::new(
    "resin_brick_slab",
    BlockBehaviourProperties::new(),
    &[
...
pub const RESIN_BRICK_WALL: Block = Block::new(
    "resin_brick_wall",
    BlockBehaviourProperties::new(),
    &[
...
pub const NETHER_BRICK_FENCE: Block = Block::new(
    "nether_brick_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const NETHER_BRICK_STAIRS: Block = Block::new(
    "nether_brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BREWING_STAND: Block = Block::new(
    "brewing_stand",
    BlockBehaviourProperties::new(),
    &[
...
pub const END_PORTAL_FRAME: Block = Block::new(
    "end_portal_frame",
    BlockBehaviourProperties::new(),
    &[
...
pub const REDSTONE_LAMP: Block = Block::new(
    "redstone_lamp",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const COCOA: Block = Block::new(
    "cocoa",
    BlockBehaviourProperties::new(),
    &[
...
pub const SANDSTONE_STAIRS: Block = Block::new(
    "sandstone_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ENDER_CHEST: Block = Block::new(
    "ender_chest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const TRIPWIRE_HOOK: Block = Block::new(
    "tripwire_hook",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
...
pub const TRIPWIRE: Block = Block::new(
    "tripwire",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACHED,
        &BlockStateProperties::DISARMED,
        &BlockStateProperties::EAST,
        &BlockStateProperties::NORTH,
        &BlockStateProperties::POWERED,
        &BlockStateProperties::SOUTH,
...
pub const SPRUCE_STAIRS: Block = Block::new(
    "spruce_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_STAIRS: Block = Block::new(
    "birch_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_STAIRS: Block = Block::new(
    "jungle_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const COMMAND_BLOCK: Block = Block::new(
    "command_block",
    BlockBehaviourProperties::new(),
    &[
...
pub const COBBLESTONE_WALL: Block = Block::new(
    "cobblestone_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const MOSSY_COBBLESTONE_WALL: Block = Block::new(
...
pub const OAK_BUTTON: Block = Block::new(
    "oak_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const SPRUCE_BUTTON: Block = Block::new(
    "spruce_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const BIRCH_BUTTON: Block = Block::new(
    "birch_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const JUNGLE_BUTTON: Block = Block::new(
    "jungle_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const ACACIA_BUTTON: Block = Block::new(
    "acacia_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const CHERRY_BUTTON: Block = Block::new(
    "cherry_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const DARK_OAK_BUTTON: Block = Block::new(
    "dark_oak_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const PALE_OAK_BUTTON: Block = Block::new(
    "pale_oak_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const MANGROVE_BUTTON: Block = Block::new(
    "mangrove_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const BAMBOO_BUTTON: Block = Block::new(
    "bamboo_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const SKELETON_SKULL: Block = Block::new(
    "skeleton_skull",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const SKELETON_WALL_SKULL: Block = Block::new(
    "skeleton_wall_skull",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WITHER_SKELETON_SKULL: Block = Block::new(
...
pub const WITHER_SKELETON_WALL_SKULL: Block = Block::new(
...
pub const ZOMBIE_HEAD: Block = Block::new(
    "zombie_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const ZOMBIE_WALL_HEAD: Block = Block::new(
    "zombie_wall_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PLAYER_HEAD: Block = Block::new(
    "player_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const PLAYER_WALL_HEAD: Block = Block::new(
    "player_wall_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CREEPER_HEAD: Block = Block::new(
    "creeper_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const CREEPER_WALL_HEAD: Block = Block::new(
    "creeper_wall_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DRAGON_HEAD: Block = Block::new(
    "dragon_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const DRAGON_WALL_HEAD: Block = Block::new(
    "dragon_wall_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PIGLIN_HEAD: Block = Block::new(
    "piglin_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const PIGLIN_WALL_HEAD: Block = Block::new(
    "piglin_wall_head",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ANVIL: Block = Block::new(
    "anvil",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const CHIPPED_ANVIL: Block = Block::new(
    "chipped_anvil",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const DAMAGED_ANVIL: Block = Block::new(
    "damaged_anvil",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const TRAPPED_CHEST: Block = Block::new(
    "trapped_chest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const COMPARATOR: Block = Block::new(
    "comparator",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DAYLIGHT_DETECTOR: Block = Block::new(
    "daylight_detector",
    BlockBehaviourProperties::new(),
    &[
...
pub const HOPPER: Block = Block::new(
    "hopper",
    BlockBehaviourProperties::new(),
    &[
...
pub const QUARTZ_PILLAR: Block = Block::new(
    "quartz_pillar",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const QUARTZ_STAIRS: Block = Block::new(
    "quartz_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ACTIVATOR_RAIL: Block = Block::new(
    "activator_rail",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWERED,
...
pub const DROPPER: Block = Block::new(
    "dropper",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const WHITE_STAINED_GLASS_PANE: Block = Block::new(
...
pub const ORANGE_STAINED_GLASS_PANE: Block = Block::new(
...
pub const MAGENTA_STAINED_GLASS_PANE: Block = Block::new(
...
pub const LIGHT_BLUE_STAINED_GLASS_PANE: Block = Block::new(
...
pub const YELLOW_STAINED_GLASS_PANE: Block = Block::new(
...
pub const LIME_STAINED_GLASS_PANE: Block = Block::new(
...
pub const PINK_STAINED_GLASS_PANE: Block = Block::new(
...
pub const GRAY_STAINED_GLASS_PANE: Block = Block::new(
...
pub const LIGHT_GRAY_STAINED_GLASS_PANE: Block = Block::new(
...
pub const CYAN_STAINED_GLASS_PANE: Block = Block::new(
...
pub const PURPLE_STAINED_GLASS_PANE: Block = Block::new(
...
pub const BLUE_STAINED_GLASS_PANE: Block = Block::new(
...
pub const BROWN_STAINED_GLASS_PANE: Block = Block::new(
...
pub const GREEN_STAINED_GLASS_PANE: Block = Block::new(
...
pub const RED_STAINED_GLASS_PANE: Block = Block::new(
...
pub const BLACK_STAINED_GLASS_PANE: Block = Block::new(
...
pub const ACACIA_STAIRS: Block = Block::new(
    "acacia_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_STAIRS: Block = Block::new(
    "cherry_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_STAIRS: Block = Block::new(
    "dark_oak_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_STAIRS: Block = Block::new(
    "pale_oak_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_STAIRS: Block = Block::new(
    "mangrove_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_STAIRS: Block = Block::new(
    "bamboo_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_MOSAIC_STAIRS: Block = Block::new(
...
pub const BARRIER: Block = Block::new(
    "barrier",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const LIGHT: Block = Block::new(
    "light",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::LEVEL,
...
pub const IRON_TRAPDOOR: Block = Block::new(
    "iron_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PRISMARINE_STAIRS: Block = Block::new(
    "prismarine_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PRISMARINE_BRICK_STAIRS: Block = Block::new(
...
pub const DARK_PRISMARINE_STAIRS: Block = Block::new(
...
pub const PRISMARINE_SLAB: Block = Block::new(
    "prismarine_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const PRISMARINE_BRICK_SLAB: Block = Block::new(
...
pub const DARK_PRISMARINE_SLAB: Block = Block::new(
...
pub const HAY_BLOCK: Block = Block::new(
    "hay_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
...
pub const SUNFLOWER: Block = Block::new(
    "sunflower",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const LILAC: Block = Block::new(
    "lilac",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const ROSE_BUSH: Block = Block::new(
    "rose_bush",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const PEONY: Block = Block::new(
    "peony",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const TALL_GRASS: Block = Block::new(
    "tall_grass",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
pub const LARGE_FERN: Block = Block::new(
    "large_fern",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
...
pub const WHITE_WALL_BANNER: Block = Block::new(
    "white_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const ORANGE_WALL_BANNER: Block = Block::new(
    "orange_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const MAGENTA_WALL_BANNER: Block = Block::new(
    "magenta_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIGHT_BLUE_WALL_BANNER: Block = Block::new(
    "light_blue_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const YELLOW_WALL_BANNER: Block = Block::new(
    "yellow_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIME_WALL_BANNER: Block = Block::new(
    "lime_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const PINK_WALL_BANNER: Block = Block::new(
    "pink_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const GRAY_WALL_BANNER: Block = Block::new(
    "gray_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIGHT_GRAY_WALL_BANNER: Block = Block::new(
    "light_gray_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const CYAN_WALL_BANNER: Block = Block::new(
    "cyan_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const PURPLE_WALL_BANNER: Block = Block::new(
    "purple_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BLUE_WALL_BANNER: Block = Block::new(
    "blue_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BROWN_WALL_BANNER: Block = Block::new(
    "brown_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const GREEN_WALL_BANNER: Block = Block::new(
    "green_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const RED_WALL_BANNER: Block = Block::new(
    "red_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BLACK_WALL_BANNER: Block = Block::new(
    "black_wall_banner",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
...
pub const RED_SANDSTONE_STAIRS: Block = Block::new(
...
pub const OAK_SLAB: Block = Block::new(
    "oak_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const SPRUCE_SLAB: Block = Block::new(
    "spruce_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const BIRCH_SLAB: Block = Block::new(
    "birch_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const JUNGLE_SLAB: Block = Block::new(
    "jungle_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const ACACIA_SLAB: Block = Block::new(
    "acacia_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const CHERRY_SLAB: Block = Block::new(
    "cherry_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const DARK_OAK_SLAB: Block = Block::new(
    "dark_oak_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const PALE_OAK_SLAB: Block = Block::new(
    "pale_oak_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const MANGROVE_SLAB: Block = Block::new(
    "mangrove_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const BAMBOO_SLAB: Block = Block::new(
    "bamboo_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const BAMBOO_MOSAIC_SLAB: Block = Block::new(
    "bamboo_mosaic_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const STONE_SLAB: Block = Block::new(
    "stone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const SMOOTH_STONE_SLAB: Block = Block::new(
    "smooth_stone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const SANDSTONE_SLAB: Block = Block::new(
    "sandstone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const CUT_SANDSTONE_SLAB: Block = Block::new(
    "cut_sandstone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const PETRIFIED_OAK_SLAB: Block = Block::new(
    "petrified_oak_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const COBBLESTONE_SLAB: Block = Block::new(
    "cobblestone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const BRICK_SLAB: Block = Block::new(
    "brick_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const STONE_BRICK_SLAB: Block = Block::new(
    "stone_brick_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const MUD_BRICK_SLAB: Block = Block::new(
    "mud_brick_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const NETHER_BRICK_SLAB: Block = Block::new(
    "nether_brick_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const QUARTZ_SLAB: Block = Block::new(
    "quartz_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const RED_SANDSTONE_SLAB: Block = Block::new(
    "red_sandstone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const CUT_RED_SANDSTONE_SLAB: Block = Block::new(
...
pub const PURPUR_SLAB: Block = Block::new(
    "purpur_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const SPRUCE_FENCE_GATE: Block = Block::new(
    "spruce_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_FENCE_GATE: Block = Block::new(
    "birch_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_FENCE_GATE: Block = Block::new(
    "jungle_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ACACIA_FENCE_GATE: Block = Block::new(
    "acacia_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_FENCE_GATE: Block = Block::new(
    "cherry_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_FENCE_GATE: Block = Block::new(
    "dark_oak_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_FENCE_GATE: Block = Block::new(
    "pale_oak_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_FENCE_GATE: Block = Block::new(
    "mangrove_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_FENCE_GATE: Block = Block::new(
    "bamboo_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SPRUCE_FENCE: Block = Block::new(
    "spruce_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const BIRCH_FENCE: Block = Block::new(
    "birch_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const JUNGLE_FENCE: Block = Block::new(
    "jungle_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const ACACIA_FENCE: Block = Block::new(
    "acacia_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const CHERRY_FENCE: Block = Block::new(
    "cherry_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const DARK_OAK_FENCE: Block = Block::new(
    "dark_oak_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const PALE_OAK_FENCE: Block = Block::new(
    "pale_oak_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const MANGROVE_FENCE: Block = Block::new(
    "mangrove_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const BAMBOO_FENCE: Block = Block::new(
    "bamboo_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const SPRUCE_DOOR: Block = Block::new(
    "spruce_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIRCH_DOOR: Block = Block::new(
    "birch_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const JUNGLE_DOOR: Block = Block::new(
    "jungle_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ACACIA_DOOR: Block = Block::new(
    "acacia_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CHERRY_DOOR: Block = Block::new(
    "cherry_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DARK_OAK_DOOR: Block = Block::new(
    "dark_oak_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PALE_OAK_DOOR: Block = Block::new(
    "pale_oak_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const MANGROVE_DOOR: Block = Block::new(
    "mangrove_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BAMBOO_DOOR: Block = Block::new(
    "bamboo_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const END_ROD: Block = Block::new(
    "end_rod",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const CHORUS_PLANT: Block = Block::new(
    "chorus_plant",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const PURPUR_PILLAR: Block = Block::new(
    "purpur_pillar",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const PURPUR_STAIRS: Block = Block::new(
    "purpur_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const PITCHER_CROP: Block = Block::new(
    "pitcher_crop",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AGE_4,
...
pub const PITCHER_PLANT: Block = Block::new(
    "pitcher_plant",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DOUBLE_BLOCK_HALF],
);
...
pub const REPEATING_COMMAND_BLOCK: Block = Block::new(
...
pub const CHAIN_COMMAND_BLOCK: Block = Block::new(
    "chain_command_block",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CONDITIONAL,
...
pub const BONE_BLOCK: Block = Block::new(
    "bone_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
...
pub const OBSERVER: Block = Block::new(
    "observer",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const SHULKER_BOX: Block = Block::new(
    "shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const WHITE_SHULKER_BOX: Block = Block::new(
    "white_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const ORANGE_SHULKER_BOX: Block = Block::new(
    "orange_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const MAGENTA_SHULKER_BOX: Block = Block::new(
    "magenta_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const LIGHT_BLUE_SHULKER_BOX: Block = Block::new(
    "light_blue_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const YELLOW_SHULKER_BOX: Block = Block::new(
    "yellow_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const LIME_SHULKER_BOX: Block = Block::new(
    "lime_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const PINK_SHULKER_BOX: Block = Block::new(
    "pink_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const GRAY_SHULKER_BOX: Block = Block::new(
    "gray_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const LIGHT_GRAY_SHULKER_BOX: Block = Block::new(
    "light_gray_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const CYAN_SHULKER_BOX: Block = Block::new(
    "cyan_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const PURPLE_SHULKER_BOX: Block = Block::new(
    "purple_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const BLUE_SHULKER_BOX: Block = Block::new(
    "blue_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const BROWN_SHULKER_BOX: Block = Block::new(
    "brown_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const GREEN_SHULKER_BOX: Block = Block::new(
    "green_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const RED_SHULKER_BOX: Block = Block::new(
    "red_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const BLACK_SHULKER_BOX: Block = Block::new(
    "black_shulker_box",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING],
);
pub const WHITE_GLAZED_TERRACOTTA: Block = Block::new(
    "white_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const ORANGE_GLAZED_TERRACOTTA: Block = Block::new(
    "orange_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const MAGENTA_GLAZED_TERRACOTTA: Block = Block::new(
    "magenta_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIGHT_BLUE_GLAZED_TERRACOTTA: Block = Block::new(
    "light_blue_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const YELLOW_GLAZED_TERRACOTTA: Block = Block::new(
    "yellow_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIME_GLAZED_TERRACOTTA: Block = Block::new(
    "lime_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const PINK_GLAZED_TERRACOTTA: Block = Block::new(
    "pink_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const GRAY_GLAZED_TERRACOTTA: Block = Block::new(
    "gray_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const LIGHT_GRAY_GLAZED_TERRACOTTA: Block = Block::new(
    "light_gray_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const CYAN_GLAZED_TERRACOTTA: Block = Block::new(
    "cyan_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const PURPLE_GLAZED_TERRACOTTA: Block = Block::new(
    "purple_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BLUE_GLAZED_TERRACOTTA: Block = Block::new(
    "blue_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BROWN_GLAZED_TERRACOTTA: Block = Block::new(
    "brown_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const GREEN_GLAZED_TERRACOTTA: Block = Block::new(
    "green_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const RED_GLAZED_TERRACOTTA: Block = Block::new(
    "red_glazed_terracotta",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BLACK_GLAZED_TERRACOTTA: Block = Block::new(
...
pub const TURTLE_EGG: Block = Block::new(
    "turtle_egg",
    BlockBehaviourProperties::new(),
...
pub const DRIED_GHAST: Block = Block::new(
    "dried_ghast",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const DEAD_TUBE_CORAL: Block = Block::new(
    "dead_tube_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_BRAIN_CORAL: Block = Block::new(
    "dead_brain_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_BUBBLE_CORAL: Block = Block::new(
    "dead_bubble_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_FIRE_CORAL: Block = Block::new(
    "dead_fire_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_HORN_CORAL: Block = Block::new(
    "dead_horn_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const TUBE_CORAL: Block = Block::new(
    "tube_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const BRAIN_CORAL: Block = Block::new(
    "brain_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const BUBBLE_CORAL: Block = Block::new(
    "bubble_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const FIRE_CORAL: Block = Block::new(
    "fire_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const HORN_CORAL: Block = Block::new(
    "horn_coral",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_TUBE_CORAL_FAN: Block = Block::new(
    "dead_tube_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_BRAIN_CORAL_FAN: Block = Block::new(
    "dead_brain_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_BUBBLE_CORAL_FAN: Block = Block::new(
    "dead_bubble_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_FIRE_CORAL_FAN: Block = Block::new(
    "dead_fire_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_HORN_CORAL_FAN: Block = Block::new(
    "dead_horn_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const TUBE_CORAL_FAN: Block = Block::new(
    "tube_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const BRAIN_CORAL_FAN: Block = Block::new(
    "brain_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const BUBBLE_CORAL_FAN: Block = Block::new(
    "bubble_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const FIRE_CORAL_FAN: Block = Block::new(
    "fire_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const HORN_CORAL_FAN: Block = Block::new(
    "horn_coral_fan",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const DEAD_TUBE_CORAL_WALL_FAN: Block = Block::new(
...
pub const DEAD_BRAIN_CORAL_WALL_FAN: Block = Block::new(
...
pub const DEAD_BUBBLE_CORAL_WALL_FAN: Block = Block::new(
...
pub const DEAD_FIRE_CORAL_WALL_FAN: Block = Block::new(
...
pub const DEAD_HORN_CORAL_WALL_FAN: Block = Block::new(
...
pub const TUBE_CORAL_WALL_FAN: Block = Block::new(
    "tube_coral_wall_fan",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BRAIN_CORAL_WALL_FAN: Block = Block::new(
...
pub const BUBBLE_CORAL_WALL_FAN: Block = Block::new(
...
pub const FIRE_CORAL_WALL_FAN: Block = Block::new(
    "fire_coral_wall_fan",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const HORN_CORAL_WALL_FAN: Block = Block::new(
    "horn_coral_wall_fan",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SEA_PICKLE: Block = Block::new(
    "sea_pickle",
    BlockBehaviourProperties::new(),
    &[
...
pub const CONDUIT: Block = Block::new(
    "conduit",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
...
pub const BAMBOO: Block = Block::new(
    "bamboo",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AGE_1,
...
pub const BUBBLE_COLUMN: Block = Block::new(
    "bubble_column",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::DRAG],
);
pub const POLISHED_GRANITE_STAIRS: Block = Block::new(
...
pub const SMOOTH_RED_SANDSTONE_STAIRS: Block = Block::new(
...
pub const MOSSY_STONE_BRICK_STAIRS: Block = Block::new(
...
pub const POLISHED_DIORITE_STAIRS: Block = Block::new(
...
pub const MOSSY_COBBLESTONE_STAIRS: Block = Block::new(
...
pub const END_STONE_BRICK_STAIRS: Block = Block::new(
...
pub const STONE_STAIRS: Block = Block::new(
    "stone_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SMOOTH_SANDSTONE_STAIRS: Block = Block::new(
...
pub const SMOOTH_QUARTZ_STAIRS: Block = Block::new(
...
pub const GRANITE_STAIRS: Block = Block::new(
    "granite_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const ANDESITE_STAIRS: Block = Block::new(
    "andesite_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const RED_NETHER_BRICK_STAIRS: Block = Block::new(
...
pub const POLISHED_ANDESITE_STAIRS: Block = Block::new(
...
pub const DIORITE_STAIRS: Block = Block::new(
    "diorite_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const POLISHED_GRANITE_SLAB: Block = Block::new(
...
pub const SMOOTH_RED_SANDSTONE_SLAB: Block = Block::new(
...
pub const MOSSY_STONE_BRICK_SLAB: Block = Block::new(
...
pub const POLISHED_DIORITE_SLAB: Block = Block::new(
...
pub const MOSSY_COBBLESTONE_SLAB: Block = Block::new(
...
pub const END_STONE_BRICK_SLAB: Block = Block::new(
...
pub const SMOOTH_SANDSTONE_SLAB: Block = Block::new(
...
pub const SMOOTH_QUARTZ_SLAB: Block = Block::new(
    "smooth_quartz_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const GRANITE_SLAB: Block = Block::new(
    "granite_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const ANDESITE_SLAB: Block = Block::new(
    "andesite_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const RED_NETHER_BRICK_SLAB: Block = Block::new(
...
pub const POLISHED_ANDESITE_SLAB: Block = Block::new(
...
pub const DIORITE_SLAB: Block = Block::new(
    "diorite_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const BRICK_WALL: Block = Block::new(
    "brick_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const PRISMARINE_WALL: Block = Block::new(
    "prismarine_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const RED_SANDSTONE_WALL: Block = Block::new(
    "red_sandstone_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const MOSSY_STONE_BRICK_WALL: Block = Block::new(
...
pub const GRANITE_WALL: Block = Block::new(
    "granite_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const STONE_BRICK_WALL: Block = Block::new(
    "stone_brick_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const MUD_BRICK_WALL: Block = Block::new(
    "mud_brick_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const NETHER_BRICK_WALL: Block = Block::new(
    "nether_brick_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const ANDESITE_WALL: Block = Block::new(
    "andesite_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const RED_NETHER_BRICK_WALL: Block = Block::new(
...
pub const SANDSTONE_WALL: Block = Block::new(
    "sandstone_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const END_STONE_BRICK_WALL: Block = Block::new(
...
pub const DIORITE_WALL: Block = Block::new(
    "diorite_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const SCAFFOLDING: Block = Block::new(
    "scaffolding",
    BlockBehaviourProperties::new(),
    &[
...
pub const LOOM: Block = Block::new(
    "loom",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BARREL: Block = Block::new(
    "barrel",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::FACING, &BlockStateProperties::OPEN],
);
pub const SMOKER: Block = Block::new(
    "smoker",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BLAST_FURNACE: Block = Block::new(
    "blast_furnace",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const GRINDSTONE: Block = Block::new(
    "grindstone",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const LECTERN: Block = Block::new(
    "lectern",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const STONECUTTER: Block = Block::new(
    "stonecutter",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::HORIZONTAL_FACING],
);
pub const BELL: Block = Block::new(
    "bell",
    BlockBehaviourProperties::new(),
    &[
...
pub const LANTERN: Block = Block::new(
    "lantern",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HANGING,
...
pub const SOUL_LANTERN: Block = Block::new(
    "soul_lantern",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HANGING,
...
pub const COPPER_LANTERN: Block = Block::new(
    "copper_lantern",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HANGING,
...
pub const EXPOSED_COPPER_LANTERN: Block = Block::new(
...
pub const WEATHERED_COPPER_LANTERN: Block = Block::new(
...
pub const OXIDIZED_COPPER_LANTERN: Block = Block::new(
...
pub const WAXED_COPPER_LANTERN: Block = Block::new(
...
pub const WAXED_EXPOSED_COPPER_LANTERN: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_LANTERN: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_LANTERN: Block = Block::new(
...
pub const CAMPFIRE: Block = Block::new(
    "campfire",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SOUL_CAMPFIRE: Block = Block::new(
    "soul_campfire",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_STEM: Block = Block::new(
    "warped_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_WARPED_STEM: Block = Block::new(
    "stripped_warped_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const WARPED_HYPHAE: Block = Block::new(
    "warped_hyphae",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_WARPED_HYPHAE: Block = Block::new(
...
pub const CRIMSON_STEM: Block = Block::new(
    "crimson_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_CRIMSON_STEM: Block = Block::new(
    "stripped_crimson_stem",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const CRIMSON_HYPHAE: Block = Block::new(
    "crimson_hyphae",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const STRIPPED_CRIMSON_HYPHAE: Block = Block::new(
...
pub const CRIMSON_SLAB: Block = Block::new(
    "crimson_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const WARPED_SLAB: Block = Block::new(
    "warped_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const CRIMSON_PRESSURE_PLATE: Block = Block::new(
    "crimson_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const WARPED_PRESSURE_PLATE: Block = Block::new(
    "warped_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const CRIMSON_FENCE: Block = Block::new(
    "crimson_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const WARPED_FENCE: Block = Block::new(
    "warped_fence",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST,
...
pub const CRIMSON_TRAPDOOR: Block = Block::new(
    "crimson_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_TRAPDOOR: Block = Block::new(
    "warped_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CRIMSON_FENCE_GATE: Block = Block::new(
    "crimson_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_FENCE_GATE: Block = Block::new(
    "warped_fence_gate",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CRIMSON_STAIRS: Block = Block::new(
    "crimson_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_STAIRS: Block = Block::new(
    "warped_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CRIMSON_BUTTON: Block = Block::new(
    "crimson_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const WARPED_BUTTON: Block = Block::new(
    "warped_button",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ATTACH_FACE,
...
pub const CRIMSON_DOOR: Block = Block::new(
    "crimson_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_DOOR: Block = Block::new(
    "warped_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const CRIMSON_SIGN: Block = Block::new(
    "crimson_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const WARPED_SIGN: Block = Block::new(
    "warped_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::ROTATION_16,
...
pub const CRIMSON_WALL_SIGN: Block = Block::new(
    "crimson_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WARPED_WALL_SIGN: Block = Block::new(
    "warped_wall_sign",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const STRUCTURE_BLOCK: Block = Block::new(
    "structure_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::STRUCTUREBLOCK_MODE],
);
pub const JIGSAW: Block = Block::new(
    "jigsaw",
    BlockBehaviourProperties::new(),
...
pub const TEST_BLOCK: Block = Block::new(
    "test_block",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::TEST_BLOCK_MODE],
);
...
pub const BEE_NEST: Block = Block::new(
    "bee_nest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BEEHIVE: Block = Block::new(
    "beehive",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BLACKSTONE_STAIRS: Block = Block::new(
    "blackstone_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BLACKSTONE_WALL: Block = Block::new(
    "blackstone_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const BLACKSTONE_SLAB: Block = Block::new(
    "blackstone_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const POLISHED_BLACKSTONE_BRICK_SLAB: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_BRICK_STAIRS: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_BRICK_WALL: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_STAIRS: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_SLAB: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_PRESSURE_PLATE: Block = Block::new(
    "polished_blackstone_pressure_plate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::POWERED],
);
pub const POLISHED_BLACKSTONE_BUTTON: Block = Block::new(
...
pub const POLISHED_BLACKSTONE_WALL: Block = Block::new(
...
pub const CANDLE: Block = Block::new(
    "candle",
    BlockBehaviourProperties::new(),
    &[
...
pub const WHITE_CANDLE: Block = Block::new(
    "white_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const ORANGE_CANDLE: Block = Block::new(
    "orange_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const MAGENTA_CANDLE: Block = Block::new(
    "magenta_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const LIGHT_BLUE_CANDLE: Block = Block::new(
    "light_blue_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const YELLOW_CANDLE: Block = Block::new(
    "yellow_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const LIME_CANDLE: Block = Block::new(
    "lime_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const PINK_CANDLE: Block = Block::new(
    "pink_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const GRAY_CANDLE: Block = Block::new(
    "gray_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const LIGHT_GRAY_CANDLE: Block = Block::new(
    "light_gray_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const CYAN_CANDLE: Block = Block::new(
    "cyan_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const PURPLE_CANDLE: Block = Block::new(
    "purple_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const BLUE_CANDLE: Block = Block::new(
    "blue_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const BROWN_CANDLE: Block = Block::new(
    "brown_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const GREEN_CANDLE: Block = Block::new(
    "green_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const RED_CANDLE: Block = Block::new(
    "red_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const BLACK_CANDLE: Block = Block::new(
    "black_candle",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::CANDLES,
...
pub const CANDLE_CAKE: Block = Block::new(
    "candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const WHITE_CANDLE_CAKE: Block = Block::new(
    "white_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const ORANGE_CANDLE_CAKE: Block = Block::new(
    "orange_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const MAGENTA_CANDLE_CAKE: Block = Block::new(
    "magenta_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const LIGHT_BLUE_CANDLE_CAKE: Block = Block::new(
    "light_blue_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const YELLOW_CANDLE_CAKE: Block = Block::new(
    "yellow_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const LIME_CANDLE_CAKE: Block = Block::new(
    "lime_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const PINK_CANDLE_CAKE: Block = Block::new(
    "pink_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const GRAY_CANDLE_CAKE: Block = Block::new(
    "gray_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const LIGHT_GRAY_CANDLE_CAKE: Block = Block::new(
    "light_gray_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const CYAN_CANDLE_CAKE: Block = Block::new(
    "cyan_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const PURPLE_CANDLE_CAKE: Block = Block::new(
    "purple_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const BLUE_CANDLE_CAKE: Block = Block::new(
    "blue_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const BROWN_CANDLE_CAKE: Block = Block::new(
    "brown_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const GREEN_CANDLE_CAKE: Block = Block::new(
    "green_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const RED_CANDLE_CAKE: Block = Block::new(
    "red_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
pub const BLACK_CANDLE_CAKE: Block = Block::new(
    "black_candle_cake",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT],
);
...
pub const AMETHYST_CLUSTER: Block = Block::new(
    "amethyst_cluster",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const LARGE_AMETHYST_BUD: Block = Block::new(
    "large_amethyst_bud",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const MEDIUM_AMETHYST_BUD: Block = Block::new(
    "medium_amethyst_bud",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const SMALL_AMETHYST_BUD: Block = Block::new(
    "small_amethyst_bud",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const TUFF_SLAB: Block = Block::new(
    "tuff_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const TUFF_STAIRS: Block = Block::new(
    "tuff_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const TUFF_WALL: Block = Block::new(
    "tuff_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const POLISHED_TUFF_SLAB: Block = Block::new(
    "polished_tuff_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const POLISHED_TUFF_STAIRS: Block = Block::new(
...
pub const POLISHED_TUFF_WALL: Block = Block::new(
    "polished_tuff_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const TUFF_BRICK_SLAB: Block = Block::new(
    "tuff_brick_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const TUFF_BRICK_STAIRS: Block = Block::new(
    "tuff_brick_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const TUFF_BRICK_WALL: Block = Block::new(
    "tuff_brick_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const SCULK_SENSOR: Block = Block::new(
    "sculk_sensor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::POWER,
...
pub const CALIBRATED_SCULK_SENSOR: Block = Block::new(
...
pub const SCULK_VEIN: Block = Block::new(
    "sculk_vein",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::DOWN,
...
pub const SCULK_CATALYST: Block = Block::new(
    "sculk_catalyst",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::BLOOM],
);
pub const SCULK_SHRIEKER: Block = Block::new(
    "sculk_shrieker",
    BlockBehaviourProperties::new(),
    &[
...
pub const OXIDIZED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const WEATHERED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const EXPOSED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const CUT_COPPER_STAIRS: Block = Block::new(
    "cut_copper_stairs",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OXIDIZED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const WEATHERED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const EXPOSED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const CUT_COPPER_SLAB: Block = Block::new(
    "cut_copper_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const WAXED_OXIDIZED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const WAXED_WEATHERED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const WAXED_EXPOSED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const WAXED_CUT_COPPER_STAIRS: Block = Block::new(
...
pub const WAXED_OXIDIZED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const WAXED_WEATHERED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const WAXED_EXPOSED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const WAXED_CUT_COPPER_SLAB: Block = Block::new(
...
pub const COPPER_DOOR: Block = Block::new(
    "copper_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const EXPOSED_COPPER_DOOR: Block = Block::new(
    "exposed_copper_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const OXIDIZED_COPPER_DOOR: Block = Block::new(
...
pub const WEATHERED_COPPER_DOOR: Block = Block::new(
...
pub const WAXED_COPPER_DOOR: Block = Block::new(
    "waxed_copper_door",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WAXED_EXPOSED_COPPER_DOOR: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_DOOR: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_DOOR: Block = Block::new(
...
pub const COPPER_TRAPDOOR: Block = Block::new(
    "copper_trapdoor",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const EXPOSED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const OXIDIZED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const WEATHERED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const WAXED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const WAXED_EXPOSED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_TRAPDOOR: Block = Block::new(
...
pub const COPPER_GRATE: Block = Block::new(
    "copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const EXPOSED_COPPER_GRATE: Block = Block::new(
    "exposed_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const WEATHERED_COPPER_GRATE: Block = Block::new(
    "weathered_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const OXIDIZED_COPPER_GRATE: Block = Block::new(
    "oxidized_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const WAXED_COPPER_GRATE: Block = Block::new(
    "waxed_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const WAXED_EXPOSED_COPPER_GRATE: Block = Block::new(
    "waxed_exposed_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const WAXED_WEATHERED_COPPER_GRATE: Block = Block::new(
    "waxed_weathered_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const WAXED_OXIDIZED_COPPER_GRATE: Block = Block::new(
    "waxed_oxidized_copper_grate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
pub const COPPER_BULB: Block = Block::new(
    "copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const EXPOSED_COPPER_BULB: Block = Block::new(
    "exposed_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const WEATHERED_COPPER_BULB: Block = Block::new(
    "weathered_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const OXIDIZED_COPPER_BULB: Block = Block::new(
    "oxidized_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const WAXED_COPPER_BULB: Block = Block::new(
    "waxed_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const WAXED_EXPOSED_COPPER_BULB: Block = Block::new(
    "waxed_exposed_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const WAXED_WEATHERED_COPPER_BULB: Block = Block::new(
    "waxed_weathered_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const WAXED_OXIDIZED_COPPER_BULB: Block = Block::new(
    "waxed_oxidized_copper_bulb",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::LIT, &BlockStateProperties::POWERED],
);
pub const COPPER_CHEST: Block = Block::new(
    "copper_chest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const EXPOSED_COPPER_CHEST: Block = Block::new(
...
pub const WEATHERED_COPPER_CHEST: Block = Block::new(
...
pub const OXIDIZED_COPPER_CHEST: Block = Block::new(
...
pub const WAXED_COPPER_CHEST: Block = Block::new(
    "waxed_copper_chest",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WAXED_EXPOSED_COPPER_CHEST: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_CHEST: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_CHEST: Block = Block::new(
...
pub const COPPER_GOLEM_STATUE: Block = Block::new(
    "copper_golem_statue",
    BlockBehaviourProperties::new(),
    &[
...
pub const EXPOSED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const WEATHERED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const OXIDIZED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const WAXED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const WAXED_EXPOSED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const WAXED_WEATHERED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const WAXED_OXIDIZED_COPPER_GOLEM_STATUE: Block = Block::new(
...
pub const LIGHTNING_ROD: Block = Block::new(
    "lightning_rod",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const EXPOSED_LIGHTNING_ROD: Block = Block::new(
...
pub const WEATHERED_LIGHTNING_ROD: Block = Block::new(
...
pub const OXIDIZED_LIGHTNING_ROD: Block = Block::new(
...
pub const WAXED_LIGHTNING_ROD: Block = Block::new(
    "waxed_lightning_rod",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::FACING,
...
pub const WAXED_EXPOSED_LIGHTNING_ROD: Block = Block::new(
...
pub const WAXED_WEATHERED_LIGHTNING_ROD: Block = Block::new(
...
pub const WAXED_OXIDIZED_LIGHTNING_ROD: Block = Block::new(
...
pub const POINTED_DRIPSTONE: Block = Block::new(
    "pointed_dripstone",
    BlockBehaviourProperties::new(),
    &[
...
pub const CAVE_VINES: Block = Block::new(
    "cave_vines",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::AGE_25,
...
pub const CAVE_VINES_PLANT: Block = Block::new(
    "cave_vines_plant",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::BERRIES],
);
...
pub const PINK_PETALS: Block = Block::new(
    "pink_petals",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const WILDFLOWERS: Block = Block::new(
    "wildflowers",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const LEAF_LITTER: Block = Block::new(
    "leaf_litter",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIG_DRIPLEAF: Block = Block::new(
    "big_dripleaf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const BIG_DRIPLEAF_STEM: Block = Block::new(
    "big_dripleaf_stem",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const SMALL_DRIPLEAF: Block = Block::new(
    "small_dripleaf",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const HANGING_ROOTS: Block = Block::new(
    "hanging_roots",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
...
pub const DEEPSLATE: Block = Block::new(
    "deepslate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
...
pub const COBBLED_DEEPSLATE_STAIRS: Block = Block::new(
...
pub const COBBLED_DEEPSLATE_SLAB: Block = Block::new(
...
pub const COBBLED_DEEPSLATE_WALL: Block = Block::new(
...
pub const POLISHED_DEEPSLATE_STAIRS: Block = Block::new(
...
pub const POLISHED_DEEPSLATE_SLAB: Block = Block::new(
...
pub const POLISHED_DEEPSLATE_WALL: Block = Block::new(
...
pub const DEEPSLATE_TILE_STAIRS: Block = Block::new(
...
pub const DEEPSLATE_TILE_SLAB: Block = Block::new(
    "deepslate_tile_slab",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::SLAB_TYPE,
...
pub const DEEPSLATE_TILE_WALL: Block = Block::new(
    "deepslate_tile_wall",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::EAST_WALL,
...
pub const DEEPSLATE_BRICK_STAIRS: Block = Block::new(
...
pub const DEEPSLATE_BRICK_SLAB: Block = Block::new(
...
pub const DEEPSLATE_BRICK_WALL: Block = Block::new(
...
pub const INFESTED_DEEPSLATE: Block = Block::new(
    "infested_deepslate",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
...
pub const OCHRE_FROGLIGHT: Block = Block::new(
    "ochre_froglight",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const VERDANT_FROGLIGHT: Block = Block::new(
    "verdant_froglight",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::AXIS],
);
pub const PEARLESCENT_FROGLIGHT: Block = Block::new(
...
pub const DECORATED_POT: Block = Block::new(
    "decorated_pot",
    BlockBehaviourProperties::new(),
    &[
...
pub const CRAFTER: Block = Block::new(
    "crafter",
    BlockBehaviourProperties::new(),
    &[
...
pub const TRIAL_SPAWNER: Block = Block::new(
    "trial_spawner",
    BlockBehaviourProperties::new(),
    &[
...
pub const VAULT: Block = Block::new(
    "vault",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::HORIZONTAL_FACING,
...
pub const HEAVY_CORE: Block = Block::new(
    "heavy_core",
    BlockBehaviourProperties::new(),
    &[&BlockStateProperties::WATERLOGGED],
);
...
pub const PALE_MOSS_CARPET: Block = Block::new(
    "pale_moss_carpet",
    BlockBehaviourProperties::new(),
    &[
        &BlockStateProperties::BOTTOM,
...
pub const PALE_HANGING_MOSS: Block = Block::new(
    "pale_hanging_moss",
    BlockBehaviourProperties::new(),
