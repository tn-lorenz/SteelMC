...
pub(crate) fn build() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=build_assets/builtin_datapacks/minecraft/data/minecraft/tags/timeline/"
    );

    let tag_dir = "build_assets/builtin_datapacks/minecraft/data/minecraft/tags/timeline";
    ...
    stream.extend(quote! {
        pub fn register_timeline_tags(registry: &mut TimelineRegistry) {
            #register_stream
        }
    });
